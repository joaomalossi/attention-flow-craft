...
const BookLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-satoshi overflow-hidden">
      {/* Fixed Header */}
      <header className="fixed top-0 left-0 right-0 z-50 glass-card border-0 border-b border-white/5">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <a 
            href={ctaUrl}
            className="glass-button-primary sheen-effect"
            target="_blank"
          ...
          <div className={`space-y-8 ${isVisible ? 'animate-fade-up' : 'opacity-0'}`}>
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                {[
                  "Como unir branding e performance sem perder dinheiro",
                  "Estratégias para construir marca e vender ao mesmo tempo", 
                  "Como medir o que realmente importa no marketing moderno"
                ].map((benefit, index) => (
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a 
                href={ctaUrl}
                className="glass-button-primary sheen-effect text-center"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <div className="relative floating-element">
              ...
              <div className="mt-6 glass-card p-4 text-center">
                <div className="space-y-2">
                  <p className="text-sm text-muted">Formato Digital</p>
                  <p className="text-2xl font-bold text-accent">R$ 29,90</p>
                  <a 
                    href={ctaUrl}
                    className="block w-full glass-button-primary sheen-effect mt-3"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Garantir acesso
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <a 
            href={ctaUrl}
            className="glass-button-primary sheen-effect inline-flex items-center"
            target="_blank"
            rel="noopener noreferrer"
          >
      ...
      <section className="py-20 px-6 bg-background-secondary/50">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              "Como funciona a nova lógica da atenção",
              "Estratégias para construir marca e vender ao mesmo tempo",
              "Como medir o que realmente importa",
              "Exemplos reais e frameworks para aplicar agora"
            ].map((item, index) => (
              <div key={index} className="glass-card p-6 sheen-effect">
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-2xl text-center">
          ...
          <div className="space-y-4">
            <a 
              href={ctaUrl}
              className="glass-button-primary sheen-effect text-xl px-12 py-6 inline-flex items-center"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <p className="text-sm text-muted">
              Envio imediato • Pagamento seguro via Uiclap
            </p>
          </div>
        </div>
      </section>
